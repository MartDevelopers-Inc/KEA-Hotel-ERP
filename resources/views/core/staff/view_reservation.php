...
<body>
    ...
    while ($row = $res->fetch_object()) {
        ...
        while ($room = $res->fetch_object()) {
            if ($room->image == '') {
                //Load Default Image
                $img = "<img src='admin/assets/img/admin.png' class='img-fluid img-thumbnail' alt='avatar'>";
            } else {
                $img = "<img src='admin/assets/img/rooms/$room->image' class='img-fluid img-thumbnail' alt='avatar'>";
            } ?>
            <!--  END NAVBAR  -->
