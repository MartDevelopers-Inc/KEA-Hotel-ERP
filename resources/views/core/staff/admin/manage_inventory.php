...
if (isset($_GET['delete'])) {
    ...
    if ($stmt) {
        ...
        $success = "Deleted" && header("refresh:1; url=manage_inventory.php");
    } else {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge outline-badge-danger text-danger" href="manage_inventory.php?delete=<?php echo $row->id; ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>
