...
<body>
    ...
    while ($row = $res->fetch_object()) {
        if ($row->dpic == '') {
            //Load Default Image
            $profile = "<img src='assets/img/admin.png' class='img-fluid img-thumbnail' alt='avatar'>";
        } else {
            $profile = "<img src='assets/img/staffs/$row->dpic' class='img-fluid img-thumbnail' alt='avatar'>";
        }
