...
if (isset($_GET['delete'])) {
    ...
    if ($stmt) {
        ...
        $success = "Deleted" && header("refresh:1; url=manage_staffs.php");
    } else {
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-success" href="view_staff.php?view=<?php echo $row->id; ?>">View </a>
                                                    <a class="badge outline-badge-primary" href="update_staff.php?update=<?php echo $row->id; ?>">Update</a>
                                                    <a class="badge outline-badge-danger text-danger" href="manage_staffs.php?delete=<?php echo $row->id; ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>
