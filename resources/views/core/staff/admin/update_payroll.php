...
if (isset($_POST['update_payroll'])) {
    ...
    $rc = $stmt->bind_param('ssss', $code, $month, $salary, $update);
    $stmt->execute();
    if ($stmt) {
        $success = "Payroll Updated" && header("refresh:1; url=payrolls.php");
    } else {
...
<body>
    ...
    <div class="main-container" id="container">
        ...
        $update = $_GET['update'];
        $ret = "SELECT * FROM `payrolls` WHERE id ='$update' ";
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" value="<?php echo $row->staff_name; ?>" readonly name="" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
