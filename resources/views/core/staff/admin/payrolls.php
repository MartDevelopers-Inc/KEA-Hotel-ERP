                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <a class="btn btn-outline-warning" href="add_payrolls.php">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge outline-badge-primary" href="update_payroll.php?update=<?php echo $row->id; ?>">Update</a>

                                                    <a class="badge outline-badge-danger text-danger" href="payrolls.php?delete=<?php echo $row->id; ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>
